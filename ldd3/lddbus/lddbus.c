...
struct device ldd_bus = {
	// change bud_id field to init_name since mrvl-3.4 not support
	.init_name   = "ldd0",
...
struct bus_type ldd_bus_type = {
	.name = "ldd",
	.match = ldd_match,
	// change hotplug field to remove since mrvl-3.4 not support
	.remove  = ldd_hotplug,
};
...
int register_ldd_driver(struct ldd_driver *driver)
{
	...
	//disable owner since not support on k3.4
